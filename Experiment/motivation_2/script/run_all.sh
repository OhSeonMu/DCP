...
JC_MODULE_PATH=/home/osm/DCP/etc/JohnnyCache
...
do
	...
	do
		TCMALLOC_MEMFS_MALLOC_PATH=$TCMALLOC_PATH LD_PRELOAD=$PRELOAD_PATH $XSBench_path/XSBench -s $size -p 10000000 > $XSBench_output_path/XSBench_${size}_${DRAM_CACHE_SIZE}
	done
